...
public class RobotBehaviour : MonoBehaviour {
    ...
    [HideInInspector]
	public bool accelerated = false; //helps with onaccelerate and ondeaccelerate
    ...
    void Awake(){
		...
		if(isPreview == false){
			Goal.OnGoalScored += new Goal.GoalScored(ResetRobotAfterScore); //reset position when a goal is made
        }
    }
